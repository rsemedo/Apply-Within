<?php
/**
 * @version		$Id: customfields.mtree.html.php 712 2009-05-25 16:24:06Z CY $
 * @package		Mosets Tree
...
class HTML_mtcustomfields {
	...
	?>
	<div style="position:relative;top:5px;clear:both;text-align:left;margin-bottom:20px;"><img style="position:relative;top:4px;" src="../components/com_mtree/img/arrow_left.png" width="16" height="16" /> <a href="index2.php?option=com_mtree&amp;task=customfields"><b><?php echo JText::_( 'Back to custom fields' ) ?></b></a></div>
	...
	if(count($rows) > 0) {
		...
		<tr class="<?php echo "row$rc"; ?>">
			...
			<td align="center"><a href="index2.php?option=<?php echo $option; ?>&amp;task=downloadft&amp;cfid=<?php echo $row->ft_id; ?>&amp;format=raw"><?php echo JText::_( 'Download' ); ?></a></td>
		</tr>
			<?php 
			$rc = $rc == 0 ? 1 : 0;
		} 
	...
	<table class="adminheading">
		<tr><td>
			<a href="index2.php?option=com_mtree&amp;task=managefieldtypes"><?php echo JText::_( 'Manage field types' ) ?></a>
		</td></tr>
	</table>
	...
	<!-- <div style="width:350px;float:right;padding-left:5px"> -->
