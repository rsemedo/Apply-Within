...
class Savant2_Plugin_rating extends Savant2_Plugin {
	...
	function plugin($rating, $votes, $attribs)
	{
		...
		if ( $params->get( 'show_rating' ) == 1 ) {
			...
			// Print starts
			for( $i=0; $i<$star; $i++) {
				$html .= '<img src="components/com_mtree/img/star_10.png" width="14" height="14" hspace="1" class="star" alt="★" />';
			}

			if( ($rating-$star) >= 0.5 && $star > 0 ) {
				$html .= '<img src="components/com_mtree/img/star_05.png" width="14" height="14" hspace="1" class="star" alt="½" />';
				$star += 1;
			}

			// Print blank star
			for( $i=$star; $i<5; $i++) {
				$html .= '<img src="components/com_mtree/img/star_00.png" width="14" height="14" hspace="1" class="star" alt="" />';
			}
